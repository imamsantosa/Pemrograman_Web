		...
		<div id="body" class="row">
			<div id="content">
				<div class="content-body">
                    <article>
                        <label id="title">
                        	<h2>Lorem sum Dolor sit Amet</h2>
                        </label>
                        <div id="author">
                            <p> Admin | Created : 29 Februari 2016 05:20:35</p>
                        </div>
                        <div id="content_artikel">
							...
							<strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetti[...]<br>
                            <a href="article/1">Selengkapnya &gt;&gt;</a></p>
                        </div>
                        <hr>
                    </article>
                     <article>
